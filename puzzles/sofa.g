...
agent (table_base){ joint:transXYPhi limits: [-1.5 1.5 -1.5 1.5 -4 4], type:ssCylinder, size:[0.1 0.15 .01], contact:1 Q:<[  -0.3, -.3, 0., 1, 0, .0, .0]> color:[0.1, 0.1, 0.9, 1], sampleUniform: 1, logical: { is_gripper } }
