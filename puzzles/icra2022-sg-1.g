...
#ego(world) {
#    shape: ssCylinder, Q: [0, 0., 0.1], size: [.2, .2, .02], logical: {ego}, limits: [-1.5, 1.5, -1.5, 1.5, -4, 4], sampleUniform: 1,
#    joint: transXYPhi, contact: 1
#}

goal (floor): { shape: ssBox, Q: <t(-1.7 1.7 0.0)>, size: [0.2, 0.2, .1, .005], color: [1., .3, .3, 0.9], contact: 0, logical: { is_goal } }
...
obj(floor) {
    shape: ssBox, Q: [-0.5, 1.4, 0.1], size: [.3, .3, 0.1, .02], nomass: 1,  color: [0.0, 0.0, 1.0],
    joint: rigid, friction: .1 contact: 1
}

#obj (world): { joint: rigid type: ssBox, size: [0.3, 0.3, 0.1, .005], contact: 1 Q: [0.5, 0.5, 0.0] color: [0.9, 0.1, 0.1]}
