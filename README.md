...
```
cd existing_repo
git remote add origin https://git.tu-berlin.de/lis/lgp-benchmarks.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.tu-berlin.de/lis/lgp-benchmarks/-/settings/integrations)
