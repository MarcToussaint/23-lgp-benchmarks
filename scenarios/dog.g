...
stick (World){ joint:rigid type:cylinder, size:[1.6 .04], contact:1 Q: [  -3, -0, 0.1, -1, 1, .0, 0] color:[0.9, 0.1, 0.1, 1]}
stick_extension (stick){ type:cylinder, size:[2 .04], contact:1 Q: [  0, -0, 0., 1, 0, .0, 0] color:[0.9, 0.9, 0.1, 1]}
