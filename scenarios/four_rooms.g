...
agent (table_base){ joint:transXY limits: [-1.3, -0.8, 1.3, 0.8], type:cylinder, size:[0.1 0.15], contact:1 Q: [  0, -.5, 0, 1, 0, .0, .0] color:[0.1, 0.1, 0.9, 1]}
#agent (table_base){ joint:transXYPhi limits: [-1.3 1.3 -0.8 0.8, -4, 4], type:cylinder, size:[0.1 0.15], contact:1 Q: [  0, -.5, 0, 1, 0, .0, .0] color:[0.1, 0.1, 0.9, 1]}
