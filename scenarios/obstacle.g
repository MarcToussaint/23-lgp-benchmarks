...
agent (table_base){ joint:transXY limits: [-1.4 -0.9 1.4 0.9], type:cylinder, size:[0.1 0.15], contact:1 Q: [  1, .5, 0., 1, 0, .0, .0] color:[0.1, 0.1, 0.9, 1]}
#agent (table_base){ joint:transXYPhi limits: [-1.4 -0.9 -4 1.4 0.9 4], type:cylinder, size:[0.1 0.15], contact:1 Q: [  1, .5, 0., 1, 0, .0, .0] color:[0.1, 0.1, 0.9, 1]}
