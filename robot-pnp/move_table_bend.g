...
Prefix: "a0_"
Include: <_mobile-manipulator-restricted.g>

Edit a0_base (World_v2) {Q: "t(5 0. .0) d(0 0 0 1)"}
#Edit a0_base (World_v2) {Q: "t(-2 0. .2) d(90 0 0 1)"}

tableWorld (World){ type:ssBox, size:[8 8 .1 .04], Q:[0 0 .5], color:[.8 .8 .8 .1], logical: { is_place } }
table (tableWorld){ joint:rigid type:ssBox, size:[1.45 0.8 0.1 .04], contact:1 Q: [  -3, -2, 0.1, 1, 0, .0, 0] color:[0.9, 0.1, 0.1, 1]}
leg_1 (table){ type:cylinder, size:[0.4 .04], contact:1 Q: [  0.6, -0.3, -0.2, 1, 0, .0, 0] color:[0.9, 0.1, 0.1, 1]}
leg_2 (table){ type:cylinder, size:[0.4 .04], contact:1 Q: [  -0.6, -0.3, -0.2, 1, 0, .0, 0] color:[0.9, 0.1, 0.1, 1]}
leg_3 (table){ type:cylinder, size:[0.4 .04], contact:1 Q: [  -0.6, 0.3, -0.2, 1, 0, .0, 0] color:[0.9, 0.1, 0.1, 1]}
leg_4 (table){ type:cylinder, size:[0.4 .04], contact:1 Q: [  0.6, 0.3, -0.2, 1, 0, .0, 0] color:[0.9, 0.1, 0.1, 1]}
marker (table){ type:marker, size:[1], Q: [  0, -0, 0., 1, 0, .0, 0] color:[0.9, 0.1, 0.1, 1]}

goal (World){ type:ssBox, size:[1.25 0.75 0.1 .005], contact:0 Q: [  2, 0, 0.6, 1, 0, .0, 1] color:[0.4, 1, 0.4, 0.3], logical: {is_pose} }
...
_obs5 (World){  type:ssBox, size:[0.2 3 2 .005], contact:1 Q: [ 3.7, -2.1, 1, 1, 0, .0, 1] color:[0.4, 0.4, 0.4, 1]}
...
_obs_l (World){  type:ssBox, size:[0.2 6 2 .005], contact:1 Q: [ 0, 0.5, 1, 1, 0, .0, .0] color:[0.4, 0.4, 0.4, 1]}
_obs_r (World){  type:ssBox, size:[0.2 6 2 .005], contact:1 Q: [ 0, -6.5, 1, 1, 0, .0, .0] color:[0.4, 0.4, 0.4, 1]}
